...
class MainBasicTableResource(resources.ModelResource):
	stu_id = fields.Field(attribute='stu_id', column_name="学号", widget=widgets.ForeignKeyWidget(Student, 'stu_id'))
...
class StudentResource(resources.ModelResource):
	...
	stu_enrollment = fields.Field(attribute='stu_enrollment', column_name="入学年份")
	...
	class Meta:
		model = Student
		fields = ['stu_id', 'stu_name', 'stu_type', 'stu_sex', 'stu_college',  'stu_enrollment', 'stu_class']
		import_id_fields = ['stu_id']
